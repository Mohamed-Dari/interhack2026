"""
Data loading for Clinic Demand Twin.

Priority order:
1. Local normalized CSVs in data/
2. Real Inibsa Excel workbook, normalized and cached to data/
3. Synthetic demo data generated by src.mock_data
...
def load_all_data(data_dir: str | Path = DATA_DIR, source: str | None = None) -> tuple[pd.DataFrame, ...]:
    ...
    Set CLINIC_TWIN_DATA_SOURCE to one of auto, csv, excel, mock to force a source.
    """
    data_dir = Path(data_dir)
